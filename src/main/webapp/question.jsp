...
<%
    ...
    if (cookies != null) {
        for (Cookie cookie : cookies) {
            ...
            // Use URLDecoder to decode the values if they were encoded
            

            // Assign values to variables for easier usage in the HTML
            if (cookieName.equals("facultyId")) {
                int facultyId = Integer.parseInt(cookieValue);
                request.setAttribute("facultyId", facultyId);
            } else if (cookieName.equals("subject")) {
                String subject = cookieValue;
                request.setAttribute("subject", subject);
            } else if (cookieName.equals("facultyName")) {
                String facultyName = cookieValue;
...
<div>
    ...
    <div class="page-container">
       ...
       <h4>Faculty Name: <span id="fname"><%= request.getAttribute("facultyName") %></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Faculty Id: <span id="fid1"><%= request.getAttribute("facultyId") %></span></h4>
<h5>Subject: <span id="sub"><%= request.getAttribute("subject") %></span>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>Section: <%= request.getAttribute("sec") %></h5>
      ...
      <div class="question">
        ...
        <div class="options">
          ...
          <input type="hidden" name="acc_year" value="${acc_year}">
            <button id="submitBtn" type="submit">Submit</button>
            <input type="hidden" id="rnumber" name="rnumber" value="${id}">
        </form>
    </div>
</div>
</body>
